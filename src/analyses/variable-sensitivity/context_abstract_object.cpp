...
abstract_object_pointert context_abstract_objectt::expression_transform(
    ...
    const namespacet &ns) const
{
  // FIXME: Shouldn't this actually wrap the result in a context? Or is
  // FIXME: it like 'read' where the responsibility to do any appropriate
  // FIXME: context wrapping is with the child, not this class?
